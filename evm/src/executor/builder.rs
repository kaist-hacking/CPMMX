...
use super::{
    inspector::{Cheatcodes, Fuzzer, InspectorStackConfig, oracle::CageEnv},
    Executor,
};
use crate::{
...
impl ExecutorBuilder {
    ...
    #[must_use]
    pub fn set_oracle(mut self, enable: bool, env: Arc<RwLock<CageEnv>>, scanner: Arc<Scanner>) -> Self {
        self.inspector_config.oracle = enable;
        self.inspector_config.cage_env = env;
        self.inspector_config.scanner = Some(scanner);
        self
    }

    /// Enables or disables the profiler
    #[must_use]
    pub fn set_profiler(mut self, enable: bool) -> Self {
        self.inspector_config.profiler = enable;
        self
    }
